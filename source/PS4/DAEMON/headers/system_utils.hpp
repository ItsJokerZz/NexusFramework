...
extern std::string get_console_type();
extern std::string get_fw_version();
extern std::string get_username(OrbisUserServiceUserId userId = 0);
...
extern int find_pid_by_procName(std::string proc_name);
